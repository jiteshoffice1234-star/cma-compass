...
export function Profile() {
  const { name, totalXp, currentStreak, longestStreak, progress, badges, dailyGoal, level: userLevel, setDailyGoal, setLevel, resetProgress, showToast, refreshProgress, uiMode, setTheme } = useStore()
